...
MOVLW 0b11000000
MOVWF ((TRISA) and 07Fh) ;CONFIGURE PORTA
MOVLW 0b01111011
MOVWF ((TRISB) and 07Fh) ;CONFIGURE PORTB
MOVLW 0b11010000
MOVWF ((TRISC) and 07Fh) ;CONFIGURE PORTC
MOVLW 0b00000000
MOVWF ((TRISD) and 07Fh) ;CONFIGURE PORTD
MOVLW 0b11111000
MOVWF ((TRISE) and 07Fh) ;CONFIGURE PORTE
MOVLW 0b00000000 ;((SSPSTAT) and 07Fh), 7=0, ((SSPSTAT) and 07Fh), 6=0, DA=0, P=0, S=0, RW=0, ((SSPSTAT) and 07Fh), 1=0, ((SSPSTAT) and 07Fh), 0=0
MOVWF ((SSPSTAT) and 07Fh) ;CONFIGURE SPI
MOVLW 0b00001111 ;PCFG=1111
MOVWF ((ADCON1) and 07Fh) ;DISABLE ANALOG INPUTS
...
MOVWF ((TXSTA) and 07Fh) ;CONFIGURE UART
MOVLW 25
MOVWF ((SPBRG) and 07Fh) ;CONFIGURE BAUD RATE
...
MOVWF ((OPTION_REG) and 07Fh) ;CONFIGURE TIMER
BANKSEL SSPCON
...
BSF ((INTCON) and 07Fh), 7 ;ENABLE INTERRUPT
LEADER_OUT
BTFSS _bit_count, 2
...
DECFSZ _gen_count, F
GOTO TAPE_NAMEBLOCK
BCF ((INTCON) and 07Fh), 7 ;STOP INTERRUPT
...
CLRF _s_reg_low
CLRF _s_reg_high
BCF _flag_reg, 0 ;INITIALIZE PSUEDO-RANDOM DATA GENERATOR
...
BTFSC ((STATUS) and 07Fh), 2
GOTO UWTD_BREAK
UWTD_NB ;((ADCON0) and 07Fh), 2 HERE IF BYTES SENT != FILE SIZE
DECFSZ _gen_count5, F
GOTO UWTD_WR_LOOP
UWTD_BREAK ;((ADCON0) and 07Fh), 2 HERE IF BYTES SENT == FILE SIZE
BSF PORTD, 2
MOVLW 0x0B
MOVWF _timeout_high
MOVLW 0xB8
